...
class ReadMiniUchuu(object):
    def __init__(self, nbody_loc, redshift):
        ...
        self.mpart = 3.270422e8 #snap_header.mass[1] * 1e10 * 1000
...
if __name__ == '__main__':
    rmu = ReadMiniUchuu(nbody_loc='/bsuhome/hwu/scratch/uchuu/MiniUchuu/', redshift=0.3)
